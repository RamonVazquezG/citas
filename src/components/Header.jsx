      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
            Gestiona citas, citas urgentes y diversos pacientes.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2 lg:w-90 lg:grid-cols-3 xl:w-105 xl:grid-cols-1">
          <div className="grid gap-4 sm:grid-cols-2 lg:w-90 lg:grid-cols-3 xl:w-105 xl:grid-cols-2">

            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-5 shadow-lg shadow-cyan-950/30">
              <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Perros registrados</p>
              <p className="mt-3 text-4xl font-black text-white">{cantidadPerros}</p>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-5 shadow-lg shadow-cyan-950/30">
              <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Gatos registrados</p>
              <p className="mt-3 text-4xl font-black text-white">{cantidadGatos}</p>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-5 shadow-lg shadow-cyan-950/30">
              <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Conejos registrados</p>
              <p className="mt-3 text-4xl font-black text-white">{cantidadConejos}</p>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-5 shadow-lg shadow-cyan-950/30">
              <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Aves registradas</p>
              <p className="mt-3 text-4xl font-black text-white">{cantidadAves}</p>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:w-90 lg:grid-cols-6 xl:w-105 xl:grid-cols-1">
